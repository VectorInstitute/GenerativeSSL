...
def get_config():
    ...
    config.timestep_respacing = "ddim25"  # Timestep respacing for DDIM sampler.
    ...
    config.diffusion_steps = 25  # Number of diffusion steps.
    ...
    config.use_fp16 = True  # If true, use 16-bit floating point precision.
