...
from data_generation.icgan.inference import utils as inference_utils
...
class ICGANInference:
    ...
    def __call__(self, input_image_tensor):
        ...
        sample = self.get_output(
            noise_vector,
            input_label if input_label is not None else None,
            instance_vector if instance_vector is not None else None,
        )
