...
parser.add_argument('--rcdm_agumentation', action="store_true", help='Use RCDM agumentation or not.')
...
def main():
    ...
    train_dataset = dataset.get_dataset(args.dataset_name, args.n_views, args.rcdm_agumentation)
